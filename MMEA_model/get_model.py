...
def parse_args(args=None):
    ...
    parser.add_argument('-init', '--init_checkpoint', default="/home/.../SSQR4LLM/Rotate-learn/models/RotatE_FB15k_0", type=str)
...
def main(args):
    ...
    if args.do_train:
        ...
        #Training Loop
        for step in range(init_step, args.max_steps): # train
